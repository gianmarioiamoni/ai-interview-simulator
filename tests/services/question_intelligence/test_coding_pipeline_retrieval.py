# tests/services/question_intelligence/test_coding_pipeline_retrieval.py
...
def test_coding_retrieval_merges_next_stage_when_pool_shallow() -> None:
    ...
    relaxed_filters = RetrievalFilters(area="technical_coding")

    chroma = MagicMock()
    chroma.search_with_filters.side_effect = [
        [_candidate("theory-id", "Explain dynamic programming.")],
        [
            _candidate("coding-1", "How would you solve Two Sum?"),
            _candidate("coding-2", "Implement merge sort."),
            _candidate("coding-3", "Write a function to reverse a list."),
        ],
    ]
