# tests/app/graph/nodes/test_mig05a_report_node.py
# MIG-05A — Structural Report Runtime Integration
#
# Verifies:
...
# 9. No new orchestrator introduced.
# 10. state.session_history remains immutable after report_node.
# 11. Idempotency: second call with report already set re-assembles (not guarded).
# 12. report.feature_count matches profile_snapshot.total_feature_count.
# 13. Architecture: no new TCP fields beyond report field.
# 14. Backward compatibility: non-completed state passes through unchanged.
