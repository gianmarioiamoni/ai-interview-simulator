...
from services.interview_reasoner.pattern_detection.detectors.evaluation_bridge_detector import EvaluationBridgeDetector
...
def build_default_registry() -> PatternDetectorRegistry:
    ...
    Registration order respects dependency constraints:
      EvaluationBridgeDetector (priority=5,  no deps)
    ...
    registry.register(EvaluationBridgeDetector())
